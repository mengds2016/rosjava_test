...
public class RobotBarActivity extends RosDialogActivity implements SurfaceHolder.Callback, Runnable{
	...
	public void onCreate(Bundle savedInstanceState) {
				...
				try {
					...
					imageButton.setOnClickListener(new OnClickListener(){
						...
						public void onClick(View v) {
							RobotBarActivity.this.chatnode.publishStringStatus("tag:" + v.getTag());
						}
					});
		...
		this.move_to_demo_button.setOnClickListener( new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent i = new Intent(RobotBarActivity.this.getApplicationContext(), DemoMakeActivity.class);
		...
		this.chatnode.setStringCallback( new RosStringCallback(){
			...
			public void messageArrive(String topic, String msg) {
				...
				RobotBarActivity.this.runOnUiThread(new Runnable() {
					@Override
					public void run() {
						RobotBarActivity.this.bottom_notf.setText("[Message arrive] " + mg + " at " + tp ) ;
					}
				});
			}
		} ) ;
	...
	protected void init(NodeMainExecutor nodeMainExecutor) {
		...
		this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				RobotBarActivity.this.bottom_notf.setText(
						RobotBarActivity.this.bottom_notf.getText()
		...
		nodeMainExecutor.execute( new AbstractNodeMain(){
			...
			public GraphName getDefaultNodeName() {
				return GraphName.of( RobotBarActivity.node_name + "/vibrate_node");
			}
			@Override
			public void onStart(final ConnectedNode connectedNode) {
				Subscriber<std_msgs.Int64> subscriber1 = connectedNode
						.newSubscriber(RobotBarActivity.node_name + "/request/vibrate", std_msgs.Int64._TYPE) ;
				subscriber1
